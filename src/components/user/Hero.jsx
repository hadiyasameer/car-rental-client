...
function Hero() {
  return (
<div className="relative h-[700px]	 bg-cover bg-center bg-[url('/images/pexels-julian-largo.jpg')] flex flex-col justify-center items-center text-white text-center px-4">
