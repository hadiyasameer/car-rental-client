  ...
  return (
    <div className="relative h-[700px]	 bg-cover bg-center bg-[url('/images/image-5.jpg')] flex flex-col justify-center items-center text-white text-center px-4">
      ...
      <div className="absolute top-5 right-5 text-right space-y-2">
        <div className='text-center text-4xl font-bold '>Earn from Your Car!</div>
        <Link to="/dealer">
          <button className="bg-black text-white font-bold text-2xl py-2 px-6 rounded hover:bg-yellow-500 transition">List Your Car Now</button>
        </Link>
      </div>
