...
function Subscribe() {
    return (
        ...
        <div className="relative h-[300px]	 bg-cover bg-center bg-[url('/images/image-1.jpg')] flex flex-col justify-center items-center text-white text-center px-4">
            ...
            <p className='relative lg:text-4xl text-xl lg:font-bold my-2 lg:mb-5'>Join our community to unlock exclusive deals, enjoy premium rides, and stay ahead with early access to special offers.</p>
