...
function Contact() {
    return (
        <div>
            ...
            <div className='contacts relative z-10 mt-10 flex  justify-center gap-10 py-10'>
                <div className='location h-[400px] w-[400px] flex lg:flex-col items-center justify-center shadow-2xl rounded-2xl transition-transform duration-300 hover:scale-105'>
                ...
                <div className='phone h-[400px] w-[400px] flex lg:flex-col items-center justify-center shadow-2xl rounded-2xl transition-transform duration-300 hover:scale-105'>
                    <div className='h-[190px] w-[190px] bg-yellow-500 flex justify-center items-center'>
                ...
                <div className='mail h-[400px] w-[400px] flex lg:flex-col items-center justify-center shadow-2xl rounded-2xl transition-transform duration-300 hover:scale-105'>
                    <div className='h-[190px] w-[190px] bg-yellow-500 flex justify-center items-center'>
